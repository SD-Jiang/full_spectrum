...
Fig4b
usage:
python Fig4b_cell_viz.py --folder "/Users/jiangshengdian/Desktop/Daily/PhD_project/Platform/fullmorpho/data/morpho_showdata/0/*"
...
### swc
N=0
for fd in sorted(glob.glob(os.path.join(args.folder,'*swc'))):
    ...
    actor2.GetProperty().SetColor(colors.GetColor3d(colordict[N%15][0]))
...
outname=args.folder.split('/')[-1]
topath='./local_figs'
tofile=os.path.join(topath,outname+'.png')
WriteImage(tofile,renWin=renderWindow,rgba=False)
print(outname,"SAVED")
